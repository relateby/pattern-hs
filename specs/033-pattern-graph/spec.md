...
**Created**: 2026-02-18  
**Status**: Draft  
**Input**: User description: "PatternGraph data structure backed by Pattern v as described in design/pattern-graph.md" (now consolidated into [design/rfc/RFC-004-graph-classifier.md](../../design/rfc/RFC-004-graph-classifier.md), Appendix A)
