...
**Created**: 2026-03-17
**Status**: Draft
**Input**: User description: "representation-map as described above and detailed in design/representation-map-proposal.md" (now consolidated into [design/rfc/RFC-007-representation-map.md](../../design/rfc/RFC-007-representation-map.md))
